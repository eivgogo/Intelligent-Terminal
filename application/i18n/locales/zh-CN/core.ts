...
export const zhCNCoreMessages: Messages = {
  ...
  'settings.update.hint': 'Intelligent Terminal 从 GitHub Releases 检查更新。',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': '打开主机库时静默导入 OpenSSH known_hosts 中的记录。关闭后，Intelligent Terminal 已知主机与系统信任库保持独立；仍可通过「扫描系统」手动导入。',
...
`,
  ...
  'settings.appearance.appIcon.desc': '选择 Dock/任务栏图标风格，切换应用时更容易找到 Intelligent Terminal。运行时生效，安装包内的图标不会改变。',
  ...
  'vault.import.progress.keepOpen': '导入正在后台进行，请保持 Intelligent Terminal 开启。',
  ...
  'pf.type.dynamic.desc': '动态转发将 Intelligent Terminal 作为 SOCKS 代理使用。',
  ...
  'settings.plugins.description': '由开发插件提供、经 Intelligent Terminal 原生组件验证的设置。',
  ...
  'plugins.authentication.description': '请在此 Intelligent Terminal 对话框中完成认证请求。',
