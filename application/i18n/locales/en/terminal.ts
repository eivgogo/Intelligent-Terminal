...
export const enTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'Intelligent Terminal will add OSC 7 prompt hooks for the current remote user. This helps SFTP follow the terminal directory after sudo or su.',
  ...
  'terminal.et.proxyUnsupported': 'EternalTerminal does not currently support Intelligent Terminal proxy settings. Use SSH or remove the proxy for this host.',
  'terminal.et.multiJumpUnsupported': 'EternalTerminal currently supports at most one jump host in Intelligent Terminal.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'Combine changes from both sides when possible; if Intelligent Terminal cannot decide safely, ask you to choose.',
  ...
  'cloudSync.localBackups.desc': 'Intelligent Terminal keeps local restore points before app version changes and before vault restores.',
  'cloudSync.localBackups.retentionTitle': 'Backup Retention',
  'cloudSync.localBackups.retentionDesc': 'Choose how many local backups Intelligent Terminal should keep.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'This platform does not expose a secure keychain to Intelligent Terminal, so local backups cannot be written safely. Install Intelligent Terminal on a system with a supported keychain to enable the local backup history.',
  ...
  'cloudSync.githubFlow.desc': 'Copy the code below and enter it on GitHub to authorize Intelligent Terminal.',
  ...
  'snippets.import.toast.invalidDesc': 'This is not a valid Intelligent Terminal snippets file.',
  ...
  'snippets.import.modal.desc': 'Choose one or more Intelligent Terminal snippets JSON files. Intelligent Terminal will preview them before anything is imported.',
