...
export const enAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Leave blank to use the model list value when available, otherwise Intelligent Terminal uses a safe default.',
  ...
  'ai.codex.customConfigMissingEnvKey': 'Warning: {envKey} is not set in your shell environment. Export it (or launch Intelligent Terminal from a shell that has it) so Codex can authenticate.',
  ...
  'ai.cursor.apiKeyEnvHint': 'Cursor can use CURSOR_API_KEY from your shell. Save a key here only if you want Intelligent Terminal to override it.',
  'ai.cursor.apiKeyOverrideHint': 'Intelligent Terminal will use the saved key here before CURSOR_API_KEY.',
  ...
  'ai.grok.runtime.acp.description':
    'Talk to Grok over Agent Client Protocol (grok agent stdio). Injects Intelligent Terminal MCP on session/new. Turn off to use the original headless streaming-json CLI path.',
  ...
  'ai.toolAccess.mode': 'Intelligent Terminal Access Mode',
  'ai.toolAccess.description': 'Choose how external agents access Intelligent Terminal sessions. MCP exposes the built-in server, while Skills + CLI points agents to the local Intelligent Terminal skill and CLI commands.',
  ...
  'ai.externalMcp.description': 'Expose Intelligent Terminal as an MCP server for external clients such as Codex, Claude Code, Cursor, and Grok. Uses the same catalog tools as in-app agents (terminal, SFTP, Vault, port forwarding). Keep Intelligent Terminal running while clients are connected.',
  ...
  'ai.externalMcp.mode.description': 'Temporary mode auto-disables after idle timeout. Always-on restores External MCP when Intelligent Terminal starts.',
  ...
  'ai.externalMcp.silentSessions.description': 'Sessions opened by AI stay out of your tab bar and are not restored after restart. Reconnect to them at any time.',
  ...
  'ai.externalMcp.usage.keepRunning': '1. Turn on External MCP and keep Intelligent Terminal running.',
  ...
  'ai.externalMcp.permissionMode.hint': 'Same setting as Settings → AI → Safety. Auto runs Intelligent Terminal write tools without Intelligent Terminal approval prompts; Confirm asks each time. External clients (Codex / Claude / Grok) may still show their own tool approval UI.',
  ...
  'ai.userSkills.description': 'Open the Intelligent Terminal skills folder to add your own skill directories. Intelligent Terminal scans these skills automatically and injects only lightweight indexes unless a skill clearly matches the current request.',
  ...
  'ai.chat.permConfirmDesc': 'Ask before Intelligent Terminal writes (Cursor CLI: agent + force)',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Codex main-process handlers are not loaded yet. Fully restart Intelligent Terminal, or restart the Electron dev process, then try again.',
  ...
  'ai.safety.permissionMode.description': 'Controls how the AI interacts with your Intelligent Terminal terminal sessions. Observer mode blocks write operations that go through Intelligent Terminal. External agent CLIs may still have their own local tools and approval flow.',
  ...
  'ai.safety.commandTimeout.description': 'Maximum seconds a command can run before being terminated through Intelligent Terminal execution.',
  ...
  'ai.safety.blocklist.description': 'Regex patterns to block dangerous commands executed through Intelligent Terminal.',
  ...
  'ai.safety.note': 'These safety settings are enforced for actions that go through Intelligent Terminal. External agent CLIs may also expose local tools that are governed by the agent itself.',
