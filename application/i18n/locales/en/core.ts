...
export const enCoreMessages: Messages = {
  ...
  'settings.update.hint': 'Intelligent Terminal checks for updates from GitHub Releases.',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': 'When Vault loads, silently import entries from the OpenSSH known_hosts file. Turn this off to keep Intelligent Terminal known hosts separate; Scan System still imports on demand.',
...
`,
  ...
  'settings.appearance.appIcon.desc': 'Choose a dock/taskbar icon style to make Intelligent Terminal easier to spot when switching apps. Applies at runtime; the installed app bundle icon is unchanged.',
  ...
  'settings.terminal.font.cjk.unavailableWarning': 'This font is not installed on this device. Intelligent Terminal will keep the setting and use a safe fallback.',
  ...
  'plugins.authentication.description': 'Complete the authentication request in this Intelligent Terminal dialog.',
