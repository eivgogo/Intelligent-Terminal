...
export const enVaultMessages: Messages = {
  ...
  'vault.import.progress.summary':
    'Imported {count} hosts; skipped {skipped}; duplicates {duplicates}.',
  'vault.import.progress.keepOpen': 'Keep Intelligent Terminal open while the import runs in the background.',
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns Intelligent Terminal into a SOCKS proxy server.',
  ...
  'settings.sshDeepLink.enable': 'Open ssh:// and telnet:// links with Intelligent Terminal',
  'settings.sshDeepLink.enableDesc': 'Allow Intelligent Terminal to handle ssh:// and telnet:// links from browsers and other apps.',
  'settings.explorerContextMenu.title': 'Windows Explorer',
  'settings.explorerContextMenu.enable': 'Show “Open in Intelligent Terminal” in folder context menus',
  ...
  'settings.jmsDeepLink.enableDesc': 'Register Intelligent Terminal as the handler for JumpServer jms:// client links. May conflict with the official JumpServer client.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'The current group has algorithm overrides set for: {categories}. The "Reset" button here falls back to the group\'s lists, not Intelligent Terminal\'s defaults. To ignore the group restriction, clear the override in the group\'s algorithm settings.',
