...
export const enVaultMessages: Messages = {
  ...
  "notes.empty.desc":
    "Create Markdown notes for runbooks, reminders, and server handoff details.",
  ...
  "vault.import.securecrt.directoryHint":
    "Select the SecureCRT Sessions folder.",
  ...
  "vault.import.securecrt.folderDesc":
    "Import every session and keep the folder structure.",
  ...
  "vault.import.progress.persistFailed":
    "Imported hosts could not be saved. Free some local storage space and try again.",
  "vault.import.progress.rollbackFailed":
    "The import could not be rolled back safely. Some imported hosts may remain; review the Vault before retrying.",
  "vault.import.progress.summary":
    "Imported {count} hosts; skipped {skipped}; duplicates {duplicates}.",
  "vault.import.progress.keepOpen":
    "Keep Intelligent Terminal open while the import runs in the background.",
  ...
  "vault.import.sshConfig.importOnlyDesc":
    "One-time import. Changes won't sync back to the file.",
  "vault.import.sshConfig.managed": "Managed Sync",
  "vault.import.sshConfig.managedDesc":
    "Keep in sync. Changes will be saved back to the file.",
  "vault.import.sshConfig.managedDestinationHint":
    "Managed sync always uses its own managed group; the destination above applies to one-time import only.",
  "vault.import.sshConfig.managedGroup": "ssh config",
  "vault.import.sshConfig.managedSuccess":
    "Imported {count} hosts. File is now managed.",
  "vault.import.sshConfig.alreadyManaged":
    "This file is already being managed.",
  "vault.import.sshConfig.alreadyManagedDesc":
    'This file is already managed under group "{group}". Remove the existing managed source first if you want to re-import.',
  "vault.import.sshConfig.noFilePath": "Cannot manage this file.",
  "vault.import.sshConfig.noFilePathDesc":
    "Unable to determine the file path. Managed sync requires access to the file system.",
  ...
  "knownHosts.toast.scanUnavailable":
    "System scan is unavailable on this platform.",
  ...
  "pf.type.local.desc":
    "Local forwarding lets you access a remote server's listening port as though it were local.",
  "pf.type.remote.desc":
    "Remote forwarding opens a port on the remote machine and forwards connections to the local (current) host.",
  "pf.type.dynamic.desc":
    "Dynamic port forwarding turns Intelligent Terminal into a SOCKS proxy server.",
  ...
  "pf.wizard.remoteHost.desc":
    "Select a host where the port will be open. Traffic from this port will be forwarded to the destination host.",
  "pf.wizard.remoteConfig.title": "Set the port and binding address:",
  "pf.wizard.remoteConfig.desc":
    "Traffic will be forwarded from the specified port and interface address of the selected host.",
  ...
  "pf.rule.summary.local":
    "Local {bindAddress}:{localPort} -> SSH tunnel -> {remoteHost}:{remotePort}",
  "pf.rule.summary.remote":
    "Remote {bindAddress}:{localPort} -> SSH tunnel -> local {remoteHost}:{remotePort}",
  ...
  "pf.tooltip.remoteDesc":
    "Remote port forwarding: Expose local services to remote host",
  "pf.tooltip.dynamicDesc":
    "Dynamic SOCKS proxy: Route traffic through SSH tunnel",
  "pf.deleteActive.title": "Delete Active Port Forwarding?",
  "pf.deleteActive.desc":
    'This port forwarding rule "{label}" is currently active. Deleting it will stop the tunnel first.',
  "pf.deleteActive.confirm": "Stop and Delete",
  "pf.form.autoStart": "Auto Start",
  "pf.form.autoStartDesc":
    "Automatically start this rule when the app launches",
  ...
  "sftp.bookmark.addGlobalTooltip":
    "Save as global bookmark (shared across all hosts)",
  ...
  "sftp.copyToOtherPane.unavailable":
    "Open the two-pane SFTP view and connect the destination pane before copying files.",
  ...
  "sftp.transfers.filesDiscoveredProgress":
    "{completed} done · {discovered} found",
  ...
  "sftp.transfers.pathConflict.paused":
    'Another transfer for "{name}" is paused. Resume or cancel it first.',
  "sftp.transfers.pathConflict.inProgress":
    'Another transfer for "{name}" is already in progress.',
  "sftp.transferCenter.title": "File Transfers",
  "sftp.transferCenter.quitConfirm":
    "{count} file transfer(s) are unfinished. Progress will be saved and must be resumed manually next time. Quit anyway?",
  ...
  "sftp.conflict.applyToAll":
    "Apply this action to all {count} remaining conflicts",
  ...
  "sftp.opener.systemAppDescription":
    "Select an application from your computer",
  "sftp.opener.onlySystemApp":
    "This file can only be opened with an external application",
  ...
  "sftp.opener.confirmDescription":
    "Do you want to always use {app} for {ext} files?",
  ...
  "sftp.opener.confirm.desc":
    "Do you want to always open .{ext} files with this application?",
  ...
  "settings.sftp.transferConcurrency.desc":
    "Maximum number of files transferred in parallel for the same endpoint, including folder contents and separately selected files. Higher values may improve speed but can overwhelm some servers.",
  "settings.sftp.transferPoolIdleTtl": "Transfer connection keep-alive",
  "settings.sftp.transferPoolIdleTtl.desc":
    "How long dedicated transfer SFTP connections stay warm after idle. Longer values reduce cold-start delay before the next upload or download. Busy transfers are never closed.",
  ...
  "settings.ssh.transportIdleTtl.desc":
    "How long a shared SSH connection stays warm after the last terminal, SFTP browse, bulk transfer, or port-forward lease is released. While warm, reconnecting to the same host can skip re-authentication (including MFA). Active sessions and transfers are never closed.",
  ...
  "settings.sftp.doubleClickBehavior.transferDesc":
    "Transfer the file to the other pane's active host",
  "settings.sshDeepLink.title": "SSH and Telnet links",
  "settings.sshDeepLink.enable":
    "Open ssh:// and telnet:// links with Intelligent Terminal",
  "settings.sshDeepLink.enableDesc":
    "Allow Intelligent Terminal to handle ssh:// and telnet:// links from browsers and other apps, plus PuTTY-style launches such as -ssh user@host -P 22 -pw password.",
  "settings.explorerContextMenu.title": "Windows Explorer",
  "settings.explorerContextMenu.enable":
    "Show “Open in Intelligent Terminal” in folder context menus",
  "settings.explorerContextMenu.enableDesc":
    "Adds a right-click item for folders and folder backgrounds so you can open a local terminal there. Applies immediately; no reinstall needed.",
  "settings.jmsDeepLink.title": "JumpServer Links",
  "settings.jmsDeepLink.enable": "Handle jms:// links",
  "settings.jmsDeepLink.enableDesc":
    "Register Intelligent Terminal as the handler for JumpServer jms:// client links. May conflict with the official JumpServer client.",

  // Settings > SFTP Auto Sync
  "settings.sftp.autoSync": "Auto-sync to remote",
  "settings.sftp.autoSync.desc":
    "Automatically sync file changes back to the remote server when opening files with external applications",
  "settings.sftp.autoSync.enable": "Enable auto-sync",
  "settings.sftp.autoSync.enableDesc":
    "When you save a file in an external application, changes will be automatically uploaded to the remote server",
  ...
  "settings.sftp.autoOpenSidebar.desc":
    "Automatically open the SFTP file browser sidebar when connecting to a host",
  "settings.sftp.autoOpenSidebar.enable": "Enable auto-open sidebar",
  "settings.sftp.autoOpenSidebar.enableDesc":
    "The SFTP sidebar will open automatically when a terminal session connects to a remote host",
  "settings.sftp.followTerminalCwd": "Follow terminal directory",
  "settings.sftp.followTerminalCwd.desc":
    "Automatically sync the sidebar SFTP browser with the terminal working directory (toggle in toolbar)",
  "settings.sftp.followTerminalCwd.enable":
    "Enable follow terminal directory by default",
  "settings.sftp.followTerminalCwd.enableDesc":
    "When the SFTP sidebar is open, follow mode stays on by default and updates after terminal cd commands",

  "settings.sftp.defaultViewMode": "Default View Mode",
  "settings.sftp.defaultViewMode.desc":
    "Choose the default view mode when opening a new SFTP tab. Per-host preferences override this setting.",
  "settings.sftp.defaultViewMode.list": "List View",
  "settings.sftp.defaultViewMode.listDesc":
    "Display files in a flat list for the current directory",
  ...
  "settings.sftp.showHiddenFiles.desc":
    "Display hidden files (dotfiles on Unix/macOS and files with the hidden attribute on Windows) in the SFTP file browser.",
  "settings.sftp.showHiddenFiles.enable": "Show hidden files",
  "settings.sftp.showHiddenFiles.enableDesc":
    "Display hidden files when browsing both local and remote filesystems",
  ...
  "settings.sftp.compressedUpload.desc":
    "Compress folders before uploading to significantly reduce transfer time.",
  "settings.sftp.compressedUpload.enable": "Enable folder compression",
  "settings.sftp.compressedUpload.enableDesc":
    "Automatically compress folders using tar before transfer. Requires tar support on the server. Falls back to regular transfer if not available.",

  "settings.sftp.skipUnchanged.enable": "Skip unchanged files",
  "settings.sftp.skipUnchanged.enableDesc":
    "Skip files whose size and modification time already match the destination (rsync-style). Disabled when replacing a folder into a staging path.",
  ...
  "quickConnect.knownHost.authenticity":
    "The authenticity of {hostname} can not be established.",
  ...
  "quickConnect.warning.unparsedOptions":
    "Some SSH arguments were ignored: {options}",
  ...
  "quickConnect.identity.hint":
    "Choose an identity to fill in its username and authentication automatically.",
  ...
  "quickConnect.identity.unavailable":
    "This identity is missing usable credentials on this device.",
  ...
  "hostDetails.sftp.fileProtocol.desc":
    "Auto tries SFTP, then falls back to SCP mode when the SFTP subsystem is unavailable (e.g. some NAS). Force SCP for hosts that only support SCP.",
  ...
  "hostDetails.sftp.sudo.desc":
    "Automatically acquire Root privileges using stored password",
  "hostDetails.sftp.sudo.passwordWarning":
    "Sudo mode requires a password. Configure one above, or ensure the server allows passwordless sudo.",
  "hostDetails.sftp.encoding": "Filename Encoding",
  "hostDetails.sftp.encoding.desc":
    "Select the encoding used to decode and send SFTP filenames.",
  "hostDetails.label.placeholder": "Label (e.g., Production Server)",
  "hostDetails.notes.label": "Notes",
  "hostDetails.notes.placeholder":
    "Hardware, project, customer, region, role...",
  "hostDetails.notes.help":
    "Supports Markdown. Do not store passwords or private keys here.",
  ...
  "hostDetails.distro.desc":
    "Auto-detect on connect, or override the distro icon manually.",
  ...
  "hostDetails.icon.autoUsesDistro":
    "Use Linux Distribution icon and selected color for this host.",
  "hostDetails.icon.customOverridesDistro":
    "Built-in icon replaces Linux Distribution for this host.",
  ...
  "hostDetails.auth.auto.desc":
    "Try the SSH agent and local keys, then use the saved password.",
  "hostDetails.auth.passwordOnly": "Password only",
  "hostDetails.auth.password.desc":
    "Use only the saved password and interactive password prompts.",
  "hostDetails.auth.key": "Key",
  "hostDetails.auth.key.desc":
    "Use the selected key, with the saved password as a fallback when present.",
  "hostDetails.auth.certificate": "Certificate",
  "hostDetails.auth.certificate.desc":
    "Use the selected SSH certificate, with the saved password as a fallback when present.",
  "hostDetails.auth.mfaFirst": "Prefer interactive auth",
  "hostDetails.auth.mfaFirst.desc":
    "For servers that require password and MFA through keyboard-interactive.",
  "hostDetails.auth.credentialRequired":
    "Select a key or certificate before saving this login method.",
  ...
  "hostDetails.systemSshAgent.desc":
    "Use keys already unlocked by macOS, Linux, Windows, 1Password, or another compatible SSH agent",
  ...
  "hostDetails.systemSshAgent.identitiesOnly.desc":
    "Do not try unrelated keys currently loaded in the agent",
  "hostDetails.systemSshAgent.notRunning": "System SSH agent is unavailable",
  "hostDetails.systemSshAgent.notRunningHint":
    "Start or unlock your SSH agent, or provide its socket path above.",
  ...
  "hostDetails.agentForwarding.desc":
    "Allow remote server to use your local SSH keys (e.g., for git operations)",
  "hostDetails.agentForwarding.agentNotRunning": "SSH Agent is not available",
  "hostDetails.agentForwarding.agentNotRunningHint":
    "No SSH agent detected. Enable OpenSSH Authentication Agent in Windows Services, or use a compatible agent such as Bitwarden, 1Password, or gpg-agent.",
  "hostDetails.section.agentForwarding": "SSH Agent",
  "hostDetails.x11Forwarding": "Forward X11 apps",
  "hostDetails.x11Forwarding.desc":
    "Show remote graphical apps on your local desktop when a local X server is running.",
  ...
  "hostDetails.deviceType.desc":
    "Enable for network equipment (switches, routers, firewalls) connected via SSH. Commands are sent as-is without shell wrapping, compatible with vendor CLIs like Huawei VRP and Cisco IOS.",
  "hostDetails.deviceType.warning":
    "AI agent commands will be sent directly without exit code tracking. Only enable for devices that do not run a standard shell.",
  ...
  "hostDetails.lineTimestamps.desc":
    "Show local time beside visible output lines for this host without changing terminal text.",
  "hostDetails.legacyAlgorithms": "Allow Legacy Algorithms",
  "hostDetails.legacyAlgorithms.desc":
    "Enable deprecated SSH algorithms (diffie-hellman-group1, ssh-dss, 3des-cbc, etc.) for connecting to older network equipment.",
  "hostDetails.legacyAlgorithms.warning":
    "These algorithms have known security weaknesses. Only enable for legacy devices that do not support modern cryptography.",
  "hostDetails.skipEcdsaHostKey": "Skip ECDSA host key",
  "hostDetails.skipEcdsaHostKey.desc":
    'Some old Huawei / Cisco switches produce non-standard ECDSA host-key signatures that cause "signature verification failed". Turning this on drops every ecdsa-sha2-* from the client offer so negotiation falls back to RSA / Ed25519.',
  "hostDetails.algorithms.advanced": "Advanced algorithm overrides",
  "hostDetails.algorithms.advanced.desc":
    "Replace the offered algorithm list for any category on a per-host basis. Leaving a category untouched uses the default; selecting a subset fully replaces the default list. Incorrect values can make the host unreachable.",
  "hostDetails.algorithms.inheritedNotice":
    "The current group has algorithm overrides set for: {categories}. The \"Reset\" button here falls back to the group's lists, not Intelligent Terminal's defaults. To ignore the group restriction, clear the override in the group's algorithm settings.",
  ...
  "hostDetails.keepalive.desc":
    "Use a custom keepalive policy for this host instead of the global setting. Useful for older routers or switches whose SSH server does not reply to keepalive@openssh.com requests — set interval to 0 to disable keepalive entirely on this host.",
  ...
  "hostDetails.keepalive.disabledHint":
    "Interval = 0 disables keepalive for this host. The session will rely on TCP-level timeouts to detect a dead connection.",
  ...
  "hostDetails.sshTimeouts.tcpConnect.desc":
    "Seconds to wait for the network connection to this host.",
  "hostDetails.sshTimeouts.authReady": "SSH auth timeout",
  "hostDetails.sshTimeouts.authReady.desc":
    "Seconds to wait after connecting for SSH negotiation and authentication to finish.",
  ...
  "hostDetails.proxyPanel.incompleteIdentity":
    "Proxy identity needs a username and password",
  "hostDetails.proxyPanel.unreadableIdentity":
    "Proxy identity password cannot be read on this device",
  "hostDetails.proxyPanel.error.required":
    "Proxy host and port, or a ProxyCommand, are required.",
  ...
  "hostDetails.chain.desc":
    "Adding another host will create a connection to {host}.",
  ...
  "hostDetails.startupCommand.placeholder":
    "Command to run on connect (e.g., cd /app && ls)",
  ...
  "hostDetails.startupCommand.runMode.help":
    "Choose how multi-line startup commands are sent after connection.",
  ...
  "hostDetails.plugin.authentication.none":
    "Provider-managed or no authentication",
  ...
  "hostDetails.plugin.configuration.schemaInvalid":
    "Configuration does not match the provider schema.",
  "hostDetails.plugin.unavailable":
    "The configured provider is unavailable. Configuration is preserved until the plugin is restored.",
  ...
  "vault.import.plugins.summary":
    "{parsed} drafts · {warnings} warnings · {errors} errors",
  "vault.import.plugins.commit": "Import preview",
  "vault.import.plugins.fileUnavailable":
    "The selected file is not available to the desktop importer bridge.",
  "vault.import.plugins.notRecognized":
    "This importer did not recognize the selected file.",
  ...
  "vault.import.plugins.validationErrors":
    "{count} drafts failed host validation and must be fixed by the importer.",
  ...
  "vault.import.plugins.moreItems":
    "{count} more items are included in this import.",
  "vault.import.plugins.moreDiagnostics":
    "{count} more diagnostics were omitted from this preview.",
};
