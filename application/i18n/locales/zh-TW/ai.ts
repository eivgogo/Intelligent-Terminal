...
export const zhTWAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': '留空時優先使用模型列表傳回的值；如果沒有，Intelligent Terminal 會使用安全預設值。',
  ...
  'ai.codex.customConfigMissingEnvKey': '警告：環境變數 {envKey} 未在目前 shell 中設定。請 export 它（或從包含該變數的 shell 啟動 Intelligent Terminal），否則 Codex 無法完成認證。',
  ...
  'ai.grok.runtime.acp.description':
    '透過 Agent Client Protocol（grok agent stdio）接入 Grok。在 session/new 注入 Intelligent Terminal MCP。關閉後使用原始 headless streaming-json CLI 路徑。',
  ...
  'ai.toolAccess.mode': 'Intelligent Terminal 介接模式',
  'ai.toolAccess.description': '選擇外部 Agent 存取 Intelligent Terminal 工作階段的方式。MCP 會公開內建伺服器，Skills + CLI 會引導 Agent 讀取本機 Skill 並呼叫 Intelligent Terminal CLI。',
  'ai.toolAccess.mode.mcp': 'MCP',
  'ai.toolAccess.mode.skills': 'Skills + CLI',

  'ai.externalMcp.title': '對外 MCP',
  'ai.externalMcp.description': '將 Intelligent Terminal 作為 MCP 伺服器暴露給 Codex、Claude Code、Cursor、Grok 等外部用戶端。工具面與應用內 Agent 相同。用戶端連線期間請保持 Intelligent Terminal 執行。',
  ...
  'ai.externalMcp.mode.description': '暫時模式會在閒置逾時後自動關閉；常開模式會在 Intelligent Terminal 啟動時還原對外 MCP。',
  ...
  'ai.externalMcp.silentSessions.description': 'AI 開啟的工作階段不會出現在分頁列，重新啟動後也不會還原。可隨時重新連線。',
  ...
  'ai.externalMcp.usage.keepRunning': '1. 開啟對外 MCP 開關，並保持 Intelligent Terminal 執行。',
  ...
  'ai.externalMcp.permissionMode.hint': '與「設定 → AI → 安全」為同一項。自動：Intelligent Terminal 寫入操作不再彈本應用審批；確認：每次詢問。外部用戶端（Codex / Claude / Grok）仍可能有自己的工具審批介面。',
  ...
  'ai.userSkills.description': '開啟 Intelligent Terminal 的 Skills 資料夾以新增你自己的技能目錄。Intelligent Terminal 會自動掃描這些 skills，預設只注入輕量索引，只有在請求明顯命中某個 skill 時才展開正文。',
  ...
  'ai.chat.permConfirmDesc': 'Intelligent Terminal 寫入前確認（Cursor CLI：agent + force）',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Codex 主程序處理器尚未載入。請完全重啟 Intelligent Terminal 或重啟 Electron 開發程序，然後重試。',
  ...
  'ai.safety.permissionMode.description': '控制 AI 透過 Intelligent Terminal 存取終端工作階段的方式。觀察者模式會阻止經由 Intelligent Terminal 的寫操作；外部 Agent CLI 可能仍有自己的本機工具和審批流程。',
  ...
  'ai.safety.commandTimeout.description': '透過 Intelligent Terminal 執行指令時允許執行的最長秒數，超時將被終止。',
  ...
  'ai.safety.blocklist.description': '用於攔截透過 Intelligent Terminal 執行的危險指令的正規表示式。',
  ...
  'ai.safety.note': '這些安全設定會約束經由 Intelligent Terminal 執行的操作。外部 Agent CLI 也可能提供本機工具，那部分由 Agent 自己的控制規則約束。',
