...
export const ruTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'Intelligent Terminal добавит хуки OSC 7 для текущего удалённого пользователя. Это помогает SFTP следовать за каталогом терминала после sudo или su.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'По возможности объединять изменения с обеих сторон; если Intelligent Terminal не сможет безопасно выбрать, он попросит вас решить вручную.',
  ...
  'cloudSync.localBackups.desc': 'Intelligent Terminal сохраняет локальные точки восстановления перед сменой версии приложения и перед восстановлением хранилища.',
  'cloudSync.localBackups.retentionTitle': 'Хранение резервных копий',
  'cloudSync.localBackups.retentionDesc': 'Выберите, сколько локальных резервных копий должен хранить Intelligent Terminal.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'Эта платформа не предоставляет Intelligent Terminal безопасное хранилище ключей, поэтому локальные резервные копии нельзя записывать безопасно. Установите Intelligent Terminal в систему с поддерживаемым keychain, чтобы включить историю локальных резервных копий.',
  ...
  'cloudSync.githubFlow.desc': 'Скопируйте код ниже и введите его на GitHub, чтобы авторизовать Intelligent Terminal.',
  ...
  'snippets.import.toast.invalidDesc': 'Это невалидный файл сниппетов Intelligent Terminal.',
  ...
  'snippets.import.modal.desc': 'Выберите один или несколько JSON-файлов сниппетов Intelligent Terminal. Intelligent Terminal сначала покажет результат разбора и ничего не импортирует без подтверждения.',
