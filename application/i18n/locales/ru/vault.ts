...
export const ruVaultMessages: Messages = {
  ...
  'vault.import.progress.keepOpen': 'Не закрывайте Intelligent Terminal, пока импорт выполняется в фоне.',
  ...
  'pf.type.dynamic.desc': 'Динамический проброс портов превращает Intelligent Terminal в SOCKS-прокси-сервер.',
  ...
  'settings.sshDeepLink.enable': 'Открывать ssh:// и telnet:// ссылки в Intelligent Terminal',
  'settings.sshDeepLink.enableDesc': 'Разрешить Intelligent Terminal обрабатывать ssh:// и telnet:// ссылки из браузеров и других приложений.',
  'settings.explorerContextMenu.title': 'Проводник Windows',
  'settings.explorerContextMenu.enable': 'Показывать «Open in Intelligent Terminal» в контекстном меню папок',
  ...
  'settings.jmsDeepLink.enableDesc': 'Зарегистрировать Intelligent Terminal как обработчик клиентских ссылок JumpServer jms://. Может конфликтовать с официальным клиентом JumpServer.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'В текущей группе заданы переопределения алгоритмов для: {categories}. Кнопка «Сбросить» здесь возвращает к спискам группы, а не к значениям Intelligent Terminal по умолчанию. Чтобы игнорировать ограничение группы, очистите переопределение в настройках алгоритмов группы.',
