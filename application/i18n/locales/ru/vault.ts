...
export const ruVaultMessages: Messages = {
  ...
  "notes.empty.desc":
    "Создавайте Markdown-заметки для инструкций, напоминаний и передачи серверов.",
  "notes.empty.group": "В этом блокноте пока нет заметок.",
  "notes.search.noResults": "Заметки не найдены.",

  // Vault hosts header/actions
  "vault.hosts.search.placeholder":
    "Найти хост или ssh user@hostname / ssh -p 2222 user@hostname...",
  ...
  "vault.hosts.export.toast.successWithSkipped":
    "Экспортировано {count} хостов в CSV ({skipped} неподдерживаемых хостов пропущено)",
  "vault.hosts.export.toast.passphrasesSkipped":
    "Не удалось прочитать {count} сохранённых парольных фраз ключей; они оставлены пустыми",
  ...
  "vault.hosts.copyCredentials.toast.success":
    "Учётные данные скопированы в буфер обмена",
  "vault.hosts.copyCredentials.toast.noPassword":
    "Для этого хоста нет сохранённого пароля",
  ...
  "vault.hosts.empty.desc":
    "Сохраняйте хосты, чтобы быстро подключаться к серверам, виртуальным машинам и контейнерам.",
  ...
  "vault.import.securecrt.directoryHint":
    "Выберите папку Sessions из SecureCRT.",
  ...
  "vault.import.securecrt.folderDesc":
    "Импортировать все сеансы с сохранением структуры папок.",
  "vault.import.securecrt.file": "Один файл сеанса",
  "vault.import.securecrt.fileDesc":
    "Импортировать один файл сеанса SecureCRT .ini.",
  ...
  "vault.import.toast.noEntries":
    "В {format} не найдено импортируемых записей.",
  ...
  "vault.import.progress.persistFailed":
    "Не удалось сохранить импортированные хосты. Освободите место в локальном хранилище и повторите попытку.",
  "vault.import.progress.rollbackFailed":
    "Не удалось безопасно отменить импорт. Некоторые хосты могли остаться в хранилище; проверьте его перед повторной попыткой.",
  "vault.import.progress.summary":
    "Импортировано: {count}; пропущено: {skipped}; дубликатов: {duplicates}.",
  "vault.import.progress.keepOpen":
    "Не закрывайте Intelligent Terminal, пока импорт выполняется в фоне.",
  "vault.import.progress.fileSummary": "{name} · файлов: {count}",
  "vault.import.progress.fileCount": "Обработано {completed} из {total}",
  "vault.import.mobaxterm.chooseEncoding":
    "Выберите способ чтения файла MobaXterm.",
  "vault.import.mobaxterm.encodingQuestion":
    "Какая кодировка используется в этом файле?",
  "vault.import.mobaxterm.auto": "Определить автоматически",
  "vault.import.mobaxterm.autoDesc":
    "Рекомендуется. UTF-8, если он корректен, иначе китайская кодировка Windows.",
  "vault.import.mobaxterm.utf8": "UTF-8",
  "vault.import.mobaxterm.utf8Desc":
    "Для файлов, сохранённых или преобразованных в UTF-8.",
  "vault.import.mobaxterm.gb18030": "Китайская Windows",
  "vault.import.mobaxterm.gb18030Desc":
    "Для старых файлов, экспортированных в китайской Windows.",
  "vault.import.sshConfig.chooseMode":
    "Выберите, как импортировать ваш файл SSH-конфига.",
  "vault.import.sshConfig.modeQuestion": "Как вы хотите выполнить импорт?",
  "vault.import.sshConfig.importOnly": "Только импорт",
  "vault.import.sshConfig.importOnlyDesc":
    "Одноразовый импорт. Изменения не будут синхронизироваться обратно в файл.",
  "vault.import.sshConfig.managed": "Управляемая синхронизация",
  "vault.import.sshConfig.managedDesc":
    "Поддерживать синхронизацию. Изменения будут сохраняться обратно в файл.",
  "vault.import.sshConfig.managedDestinationHint":
    "Управляемая синхронизация всегда использует отдельную группу; выбранная выше группа применяется только к разовому импорту.",
  "vault.import.sshConfig.managedGroup": "конфигурация SSH",
  "vault.import.sshConfig.managedSuccess":
    "Импортировано {count} хостов. Файл теперь находится под управлением.",
  "vault.import.sshConfig.alreadyManaged":
    "Этот файл уже находится под управлением.",
  "vault.import.sshConfig.alreadyManagedDesc":
    'Этот файл уже управляется в группе "{group}". Если хотите импортировать его заново, сначала удалите существующий управляемый источник.',
  "vault.import.sshConfig.noFilePath": "Невозможно управлять этим файлом.",
  "vault.import.sshConfig.noFilePathDesc":
    "Не удалось определить путь к файлу. Для управляемой синхронизации нужен доступ к файловой системе.",
  ...
  "knownHosts.toast.scanUnavailable":
    "Сканирование системы недоступно на этой платформе.",
  "knownHosts.toast.scanNoFile": "Системный файл known_hosts не найден.",
  "knownHosts.toast.scanNoEntries":
    "В known_hosts не найдено пригодных записей.",
  "knownHosts.toast.scanImported": "Импортировано новых хостов: {count}.",
  "knownHosts.toast.scanNoNew": "Новых хостов не найдено.",
  "knownHosts.toast.scanFailed":
    "Не удалось просканировать системный known_hosts.",

  // Port Forwarding
  "pf.empty.title": "Настройте проброс портов",
  "pf.empty.desc":
    "Сохраняйте правила проброса портов для доступа к базам данных, веб-приложениям и другим сервисам.",
  ...
  "pf.type.local.desc":
    "Локальный проброс позволяет обращаться к прослушиваемому порту удалённого сервера так, как будто он локальный.",
  "pf.type.remote.desc":
    "Удалённый проброс открывает порт на удалённой машине и перенаправляет подключения на локальный (текущий) хост.",
  "pf.type.dynamic.desc":
    "Динамический проброс портов превращает Intelligent Terminal в SOCKS-прокси-сервер.",
  "pf.wizard.type.title": "Выберите тип проброса портов:",
  "pf.wizard.localConfig.title": "Укажите локальный порт и адрес привязки:",
  "pf.wizard.localConfig.desc":
  ...
  "pf.wizard.remoteHost.desc":
    "Выберите хост, на котором будет открыт порт. Трафик с этого порта будет перенаправляться на конечный хост.",
  "pf.wizard.remoteConfig.title": "Укажите порт и адрес привязки:",
  "pf.wizard.remoteConfig.desc":
    "Трафик будет перенаправляться с указанного порта и адреса интерфейса выбранного хоста.",
  "pf.wizard.remoteConfig.remotePort": "Номер удалённого порта *",
  "pf.wizard.destination.title": "Выберите конечный хост:",
  "pf.wizard.destination.desc.local":
    "Введите удалённый адрес назначения, к которому вы хотите получить доступ через туннель.",
  "pf.wizard.destination.desc.remote":
    "Адрес назначения и порт, на которые будет перенаправляться трафик.",
  "pf.wizard.destination.address": "Адрес назначения *",
  "pf.wizard.destination.addressPlaceholder":
    "например, 127.0.0.1 или 192.168.1.100",
  "pf.wizard.destination.port": "Номер порта назначения *",
  "pf.wizard.sshServer.title": "Выберите SSH-сервер:",
  "pf.wizard.sshServer.desc.dynamic":
    "Выберите SSH-сервер, который будет работать как SOCKS-прокси.",
  "pf.wizard.sshServer.desc.default":
    "Выберите SSH-сервер, который будет туннелировать ваш трафик к адресу назначения.",
  ...
  "pf.rule.summary.local":
    "Локально {bindAddress}:{localPort} -> SSH-туннель -> удалённо {remoteHost}:{remotePort}",
  "pf.rule.summary.remote":
    "Удалённо {bindAddress}:{localPort} -> SSH-туннель -> локально {remoteHost}:{remotePort}",
  ...
  "pf.tooltip.localDesc":
    "Локальный проброс портов: доступ к удалённым сервисам через SSH-туннель",
  "pf.tooltip.remoteDesc":
    "Удалённый проброс портов: публикация локальных сервисов на удалённом хосте",
  "pf.tooltip.dynamicDesc":
    "Динамический SOCKS-прокси: маршрутизация трафика через SSH-туннель",
  "pf.deleteActive.title": "Удалить активное правило проброса портов?",
  "pf.deleteActive.desc":
    'Правило проброса портов "{label}" сейчас активно. При удалении туннель будет сначала остановлен.',
  "pf.deleteActive.confirm": "Остановить и удалить",
  "pf.form.autoStart": "Автозапуск",
  "pf.form.autoStartDesc":
    "Автоматически запускать это правило при запуске приложения",
  ...
  "sftp.bookmark.addGlobalTooltip":
    "Сохранить как глобальную закладку (общую для всех хостов)",
  ...
  "sftp.copyToOtherPane.unavailable":
    "Откройте двухпанельный режим SFTP и подключите панель назначения перед копированием файлов.",
  ...
  "sftp.transfers.filesDiscoveredProgress":
    "{completed} готово · {discovered} найдено",
  ...
  "sftp.transfers.pathConflict.paused":
    "Другая передача «{name}» приостановлена. Сначала возобновите или отмените её.",
  "sftp.transfers.pathConflict.inProgress":
    "Другая передача «{name}» уже выполняется.",
  "sftp.transferCenter.title": "Передача файлов",
  "sftp.transferCenter.quitConfirm":
    "Незавершённых передач: {count}. Прогресс будет сохранён, а после следующего запуска передачу нужно продолжить вручную. Выйти?",
  ...
  "sftp.followTerminalCwd.disable":
    "Отключить следование за каталогом терминала",
  ...
  "sftp.deleteConfirm.desc":
    "Это действие нельзя отменить. Будет удалено следующее:",
  ...
  "sftp.error.invalidFileName":
    "Имя файла содержит недопустимые символы: {chars}",
  "sftp.error.reservedName": "Это имя файла зарезервировано системой",
  "sftp.overwrite.title": "Файл уже существует",
  "sftp.overwrite.desc":
    'Файл с именем "{name}" уже существует. Хотите заменить его?',
  ...
  "sftp.pane.chooseFilesystem":
    "Выберите локальную или удалённую файловую систему для просмотра",
  ...
  "sftp.conflict.applyToAll":
    "Применить это действие ко всем оставшимся конфликтам ({count})",
  ...
  "sftp.opener.onlySystemApp":
    "Этот файл можно открыть только во внешнем приложении",
  ...
  "sftp.opener.confirmDescription":
    "Хотите всегда использовать {app} для файлов {ext}?",
  ...
  "sftp.opener.confirm.desc":
    "Хотите всегда открывать файлы .{ext} этим приложением?",
  ...
  "sftp.editor.unsavedChanges":
    "У вас есть несохранённые изменения. Всё равно закрыть?",
  ...
  "settings.sftp.transferConcurrency.desc":
    "Максимальное число файлов, одновременно передаваемых для одной цели, включая содержимое папок и отдельно выбранные файлы. Большие значения могут ускорить передачу, но перегрузить некоторые серверы.",
  "settings.sftp.transferPoolIdleTtl": "Удержание transfer-соединений",
  "settings.sftp.transferPoolIdleTtl.desc":
    "Как долго простаивающие SFTP-соединения пула передачи остаются открытыми. Большее время снижает задержку перед следующей передачей. Активные передачи не закрываются.",
  ...
  "settings.ssh.transportIdleTtl.desc":
    "Как долго общее SSH-соединение остаётся открытым после освобождения последнего lease терминала, SFTP-браузера, пакетной передачи или проброса портов. Пока оно тёплое, повторное подключение к тому же хосту может обойти повторную аутентификацию (включая MFA). Активные сессии и передачи не закрываются.",
  ...
  "settings.sftp.defaultOpener.desc":
    "Выберите приложение по умолчанию для открытия файлов без конкретной ассоциации",
  "settings.sftp.defaultOpener.ask": "Всегда спрашивать",
  "settings.sftp.defaultOpener.askDesc":
    "Каждый раз показывать диалог выбора приложения",
  "settings.sftp.defaultOpener.builtInDesc":
    "По умолчанию открывать текстовые файлы во встроенном редакторе",
  "settings.sftp.defaultOpener.systemApp": "Выбрать приложение...",
  "settings.sftp.defaultOpener.systemAppDesc":
    "По умолчанию открывать файлы в конкретном приложении",
  "settings.sftpFileAssociations.title": "Ассоциации файлов SFTP",
  "settings.sftpFileAssociations.desc":
    "Настройка приложений по умолчанию для открытия файлов по расширению",
  "settings.sftpFileAssociations.extension": "Расширение",
  "settings.sftpFileAssociations.application": "Приложение",
  "settings.sftpFileAssociations.noAssociations":
    "Ассоциации файлов не настроены",
  "settings.sftpFileAssociations.remove": "Удалить",
  "settings.sftpFileAssociations.removeConfirm":
    "Удалить ассоциацию для .{ext}?",

  // Settings > SFTP Behavior
  "settings.sftp.doubleClickBehavior": "Поведение двойного щелчка",
  "settings.sftp.doubleClickBehavior.desc":
    "Выберите действие при двойном щелчке по файлу в SFTP-режиме",
  "settings.sftp.doubleClickBehavior.open": "Открыть файл",
  "settings.sftp.doubleClickBehavior.transfer": "Передать в другую панель",
  "settings.sftp.doubleClickBehavior.openDesc":
    "Открыть файл в приложении по умолчанию",
  "settings.sftp.doubleClickBehavior.transferDesc":
    "Передать файл на активный хост другой панели",
  "settings.sshDeepLink.title": "SSH- и Telnet-ссылки",
  "settings.sshDeepLink.enable":
    "Открывать ssh:// и telnet:// ссылки в Intelligent Terminal",
  "settings.sshDeepLink.enableDesc":
    "Разрешить Intelligent Terminal обрабатывать ssh:// и telnet:// ссылки из браузеров и других приложений, а также запуски в стиле PuTTY, например -ssh user@host -P 22 -pw password.",
  "settings.explorerContextMenu.title": "Проводник Windows",
  "settings.explorerContextMenu.enable":
    "Показывать «Open in Intelligent Terminal» в контекстном меню папок",
  "settings.explorerContextMenu.enableDesc":
    "Добавляет пункт в меню папок и фона папки, чтобы открыть локальный терминал в этом каталоге. Применяется сразу, переустановка не нужна.",
  ...
  "settings.jmsDeepLink.enableDesc":
    "Зарегистрировать Intelligent Terminal как обработчик клиентских ссылок JumpServer jms://. Может конфликтовать с официальным клиентом JumpServer.",

  // Settings > SFTP Auto Sync
  "settings.sftp.autoSync": "Автосинхронизация с удалённым сервером",
  "settings.sftp.autoSync.desc":
    "Автоматически синхронизировать изменения файлов обратно на удалённый сервер при открытии файлов во внешних приложениях",
  "settings.sftp.autoSync.enable": "Включить автосинхронизацию",
  "settings.sftp.autoSync.enableDesc":
    "Когда вы сохраняете файл во внешнем приложении, изменения автоматически загружаются на удалённый сервер",

  // Settings > SFTP Auto Open Sidebar
  "settings.sftp.autoOpenSidebar":
    "Автооткрытие боковой панели при подключении",
  "settings.sftp.autoOpenSidebar.desc":
    "Автоматически открывать боковую панель файлового браузера SFTP при подключении к хосту",
  "settings.sftp.autoOpenSidebar.enable":
    "Включить автооткрытие боковой панели",
  "settings.sftp.autoOpenSidebar.enableDesc":
    "Боковая панель SFTP будет автоматически открываться при подключении терминальной сессии к удалённому хосту",
  "settings.sftp.followTerminalCwd": "Следовать за каталогом терминала",
  "settings.sftp.followTerminalCwd.desc":
    "Автоматически синхронизировать боковую панель SFTP с рабочим каталогом терминала (переключатель на панели инструментов)",
  "settings.sftp.followTerminalCwd.enable": "Включать следование по умолчанию",
  "settings.sftp.followTerminalCwd.enableDesc":
    "При открытой боковой панели SFTP режим следования включён по умолчанию и обновляется после команд cd в терминале",

  "settings.sftp.defaultViewMode": "Режим просмотра по умолчанию",
  "settings.sftp.defaultViewMode.desc":
    "Выберите режим просмотра по умолчанию при открытии новой вкладки SFTP. Настройки конкретного хоста имеют приоритет.",
  "settings.sftp.defaultViewMode.list": "Список",
  "settings.sftp.defaultViewMode.listDesc":
    "Показывать файлы в виде плоского списка для текущего каталога",
  "settings.sftp.defaultViewMode.tree": "Дерево",
  "settings.sftp.defaultViewMode.treeDesc":
    "Показывать файлы в иерархической древовидной структуре",

  "sftp.autoSync.success":
    "Файл синхронизирован с удалённым сервером: {fileName}",
  ...
  "sftp.reconnecting.desc":
    "Соединение потеряно, выполняется попытка переподключения",
  "sftp.reconnected": "Соединение восстановлено",
  "sftp.error.reconnectFailed":
    "Не удалось переподключиться. Попробуйте ещё раз.",
  "sftp.error.connectionLostManual":
    "Соединение потеряно. Пожалуйста, переподключитесь вручную.",
  "sftp.error.connectionLostReconnecting":
    "Соединение потеряно. Переподключение...",
  "sftp.error.sessionLost":
    "SFTP-сессия потеряна. Пожалуйста, переподключитесь.",

  // Settings > SFTP Show Hidden Files
  "settings.sftp.showHiddenFiles": "Показывать скрытые файлы",
  "settings.sftp.showHiddenFiles.desc":
    "Показывать скрытые файлы (dotfiles в Unix/macOS и файлы с атрибутом hidden в Windows) в файловом браузере SFTP.",
  "settings.sftp.showHiddenFiles.enable": "Показывать скрытые файлы",
  "settings.sftp.showHiddenFiles.enableDesc":
    "Показывать скрытые файлы при просмотре как локальной, так и удалённой файловой системы",

  // Settings > SFTP Compressed Upload
  "settings.sftp.compressedUpload": "Передача со сжатием папок",
  "settings.sftp.compressedUpload.desc":
    "Сжимать папки перед загрузкой, чтобы значительно сократить время передачи.",
  "settings.sftp.compressedUpload.enable": "Включить сжатие папок",
  "settings.sftp.compressedUpload.enableDesc":
    "Автоматически сжимать папки с помощью tar перед передачей. Требует поддержки tar на сервере. Если она недоступна, будет использована обычная передача.",

  "settings.sftp.skipUnchanged.enable": "Пропускать неизменённые файлы",
  "settings.sftp.skipUnchanged.enableDesc":
    "Пропускать файлы, у которых размер и время изменения уже совпадают с назначением (в стиле rsync). Отключается при замене папки во временный путь.",
  ...
  "quickConnect.knownHost.authenticity":
    "Подлинность {hostname} не может быть установлена.",
  "quickConnect.knownHost.fingerprintLabel": "Отпечаток {keyType} — SHA256:",
  "quickConnect.knownHost.addQuestion":
    "Хотите добавить его в список известных хостов?",
  "quickConnect.knownHost.addAndContinue": "Добавить и продолжить",
  "quickConnect.addKey": "Добавить ключ",
  "quickConnect.warning.unparsedOptions":
    "Некоторые аргументы SSH были проигнорированы: {options}",
  ...
  "quickConnect.identity.hint":
    "Выберите профиль, чтобы автоматически подставить имя пользователя и способ входа.",
  ...
  "quickConnect.identity.unavailable":
    "Для этого профиля нет доступных учётных данных на устройстве.",
  ...
  "hostDetails.sftp.fileProtocol.desc":
    "Авто сначала пробует SFTP, затем SCP-режим, если подсистема SFTP недоступна. Принудительный SCP — для хостов только с SCP.",
  ...
  "hostDetails.sftp.sudo.desc":
    "Автоматически получать привилегии Root с помощью сохранённого пароля",
  "hostDetails.sftp.sudo.passwordWarning":
    "Для режима sudo требуется пароль. Укажите его выше или убедитесь, что сервер разрешает sudo без пароля.",
  "hostDetails.sftp.encoding": "Кодировка имён файлов",
  "hostDetails.sftp.encoding.desc":
    "Выберите кодировку, используемую для декодирования и отправки имён файлов SFTP.",
  "hostDetails.label.placeholder": "Метка (например, Production Server)",
  "hostDetails.notes.label": "Заметки",
  "hostDetails.notes.placeholder":
    "Оборудование, проект, клиент, регион, роль...",
  "hostDetails.notes.help":
    "Поддерживается Markdown. Не храните здесь пароли и закрытые ключи.",
  ...
  "hostDetails.distro.desc":
    "Автоопределение при подключении или ручная замена значка дистрибутива.",
  ...
  "hostDetails.icon.autoUsesDistro":
    "Использует значок дистрибутива Linux и выбранный цвет для этого хоста.",
  "hostDetails.icon.customOverridesDistro":
    "Встроенный значок заменяет значок дистрибутива Linux для этого хоста.",
  ...
  "hostDetails.auth.auto.desc":
    "Сначала использовать SSH-агент и локальные ключи, затем сохранённый пароль.",
  "hostDetails.auth.passwordOnly": "Только пароль",
  "hostDetails.auth.password.desc":
    "Использовать только сохранённый пароль и интерактивные запросы пароля.",
  "hostDetails.auth.key": "Ключ",
  "hostDetails.auth.key.desc":
    "Использовать выбранный ключ и сохранённый пароль как запасной вариант.",
  "hostDetails.auth.certificate": "Сертификат",
  "hostDetails.auth.certificate.desc":
    "Использовать выбранный SSH-сертификат и сохранённый пароль как запасной вариант.",
  "hostDetails.auth.mfaFirst": "Сначала интерактивная аутентификация",
  "hostDetails.auth.mfaFirst.desc":
    "Для серверов, которым нужны пароль и MFA через keyboard-interactive.",
  "hostDetails.auth.credentialRequired":
    "Перед сохранением этого способа входа выберите ключ или сертификат.",
  "hostDetails.identity.suggestions": "Идентификаторы",
  "hostDetails.identity.missing": "Идентификатор не найден",
  "hostDetails.credential.keyCertificate":
    "Ключ, сертификат, локальный файл ключа",
  ...
  "hostDetails.systemSshAgent.desc":
    "Использовать ключи, разблокированные macOS, Linux, Windows, 1Password или другим совместимым агентом",
  "hostDetails.systemSshAgent.socket": "Сокет агента",
  "hostDetails.systemSshAgent.socket.desc":
    "Оставьте пустым, чтобы использовать SSH_AUTH_SOCK",
  "hostDetails.systemSshAgent.identitiesOnly": "Только настроенные ключи",
  "hostDetails.systemSshAgent.identitiesOnly.desc":
    "Не пробовать другие ключи, загруженные в агент",
  "hostDetails.systemSshAgent.notRunning": "Системный SSH-агент недоступен",
  "hostDetails.systemSshAgent.notRunningHint":
    "Запустите или разблокируйте SSH-агент либо укажите путь к его сокету выше.",
  ...
  "hostDetails.agentForwarding.desc":
    "Разрешить удалённому серверу использовать ваши локальные SSH-ключи (например, для операций git)",
  "hostDetails.agentForwarding.agentNotRunning": "SSH-агент недоступен",
  "hostDetails.agentForwarding.agentNotRunningHint":
    "SSH-агент не обнаружен. Включите OpenSSH Authentication Agent в службах Windows или используйте совместимый агент, например Bitwarden, 1Password или gpg-agent.",
  ...
  "hostDetails.x11Forwarding.desc":
    "Показывать удалённые графические приложения на вашем локальном рабочем столе, если запущен локальный X-сервер.",
  ...
  "hostDetails.deviceType.desc":
    "Включайте для сетевого оборудования (коммутаторов, маршрутизаторов, межсетевых экранов), подключённого по SSH. Команды отправляются как есть, без обёртки оболочки, что совместимо с CLI вендоров вроде Huawei VRP и Cisco IOS.",
  "hostDetails.deviceType.warning":
    "Команды AI-агента будут отправляться напрямую без отслеживания кода выхода. Включайте только для устройств, на которых нет стандартной оболочки.",
  ...
  "hostDetails.lineTimestamps.desc":
    "Показывать локальное время рядом с видимыми строками вывода для этого хоста, не изменяя текст терминала.",
  "hostDetails.legacyAlgorithms": "Разрешить устаревшие алгоритмы",
  "hostDetails.legacyAlgorithms.desc":
    "Включить устаревшие SSH-алгоритмы (diffie-hellman-group1, ssh-dss, 3des-cbc и т. д.) для подключения к старому сетевому оборудованию.",
  "hostDetails.legacyAlgorithms.warning":
    "У этих алгоритмов есть известные слабые места безопасности. Включайте только для устаревших устройств, которые не поддерживают современную криптографию.",
  "hostDetails.skipEcdsaHostKey": "Пропустить ключ хоста ECDSA",
  "hostDetails.skipEcdsaHostKey.desc":
    'Некоторые старые коммутаторы Huawei / Cisco выдают нестандартные подписи ECDSA host-key, из-за чего соединение падает с "signature verification failed". Включение этой опции убирает все ecdsa-sha2-* из предложения клиента, и согласование переходит к RSA / Ed25519.',
  "hostDetails.algorithms.advanced": "Дополнительные настройки алгоритмов",
  "hostDetails.algorithms.advanced.desc":
    "Заменить предлагаемый список алгоритмов для любой категории для конкретного хоста. Не трогать категорию = использовать значение по умолчанию; выбранное подмножество полностью заменяет список по умолчанию. Неверные значения могут сделать хост недоступным.",
  "hostDetails.algorithms.inheritedNotice":
    "В текущей группе заданы переопределения алгоритмов для: {categories}. Кнопка «Сбросить» здесь возвращает к спискам группы, а не к значениям Intelligent Terminal по умолчанию. Чтобы игнорировать ограничение группы, очистите переопределение в настройках алгоритмов группы.",
  ...
  "hostDetails.keepalive.desc":
    "Использовать для этого хоста собственную политику keepalive вместо глобальной настройки. Полезно для старых маршрутизаторов и коммутаторов, чей SSH-сервер не отвечает на запросы keepalive@openssh.com. Установите интервал 0, чтобы полностью отключить keepalive для этого хоста.",
  ...
  "hostDetails.keepalive.disabledHint":
    "Интервал = 0 отключает keepalive для этого хоста. Для определения разорванного соединения сессия будет полагаться на TCP-таймауты.",
  "hostDetails.section.sshTimeouts": "Тайм-ауты SSH-подключения",
  "hostDetails.sshTimeouts.tcpConnect": "Тайм-аут TCP",
  "hostDetails.sshTimeouts.tcpConnect.desc":
    "Сколько секунд ждать сетевого подключения к этому хосту.",
  "hostDetails.sshTimeouts.authReady": "Тайм-аут SSH-входа",
  "hostDetails.sshTimeouts.authReady.desc":
    "Сколько секунд ждать согласования SSH и завершения аутентификации после подключения.",
  ...
  "hostDetails.proxyPanel.commandPlaceholder":
    "cloudflared access ssh --hostname %h",
  "hostDetails.proxyPanel.commandHelp":
    "Используйте %h для целевого хоста, %p для целевого порта и %% для символа процента.",
  ...
  "hostDetails.proxyPanel.missingIdentity":
    "Идентификатор из связки ключей отсутствует",
  "hostDetails.proxyPanel.incompleteIdentity":
    "Для идентификатора прокси нужны имя пользователя и пароль",
  "hostDetails.proxyPanel.unreadableIdentity":
    "Пароль идентификатора прокси нельзя прочитать на этом устройстве",
  "hostDetails.proxyPanel.error.required":
    "Требуются хост и порт прокси или ProxyCommand.",
  ...
  "hostDetails.envVars.note":
    "Некоторые SSH-серверы по умолчанию разрешают только переменные с префиксом LC_ и LANG_.",
  ...
  "hostDetails.chain.desc":
    "Добавление ещё одного хоста создаст подключение к {host}.",
  ...
  "hostDetails.startupCommand.placeholder":
    "Команда для запуска при подключении (например, cd /app && ls)",
  ...
  "hostDetails.startupCommand.runMode.help":
    "Выберите, как отправлять многострочные команды запуска после подключения.",
  ...
  "hostDetails.plugin.authentication.placeholder":
    "Выберите провайдер аутентификации",
  "hostDetails.plugin.authentication.none":
    "Управляется провайдером или не требуется",
  ...
  "hostDetails.plugin.credential.unavailable":
    "Сохранённые учётные данные недоступны",
  "hostDetails.plugin.configuration.label": "Конфигурация провайдера (JSON)",
  "hostDetails.plugin.configuration.invalid":
    "Конфигурация должна быть допустимым JSON.",
  "hostDetails.plugin.configuration.schemaInvalid":
    "Конфигурация не соответствует схеме провайдера.",
  "hostDetails.plugin.unavailable":
    "Настроенный провайдер недоступен. Конфигурация сохранится до восстановления плагина.",
  ...
  "hostForm.auth.noKeysHint":
    "В связке ключей не найдено SSH-ключей. Сначала создайте один.",
  "hostForm.saveHost": "Сохранить хост",
  "vault.import.plugins.title": "Импортёры плагинов",
  "vault.import.plugins.loading":
    "Создание безопасного предварительного просмотра…",
  "vault.import.plugins.progress":
    "Обработано {completed} из {total} {message}",
  ...
  "vault.import.plugins.summary":
    "Черновики: {parsed} · предупреждения: {warnings} · ошибки: {errors}",
  "vault.import.plugins.commit": "Импортировать предварительный просмотр",
  "vault.import.plugins.fileUnavailable":
    "Мост настольного импортёра не может получить доступ к выбранному файлу.",
  "vault.import.plugins.notRecognized":
    "Этот импортёр не распознал выбранный файл.",
  "vault.import.plugins.containsErrors":
    "Предварительный просмотр содержит ошибки и не может быть применён.",
  "vault.import.plugins.committed":
    "Импортировано проверенных элементов: {count}.",
  "vault.import.plugins.duplicates": "Дубликаты будут пропущены: {count}.",
  "vault.import.plugins.validationErrors":
    "Черновики не прошли проверку хоста: {count}. Импортёр должен исправить их.",
  ...
  "vault.import.plugins.moreDiagnostics":
    "В предварительном просмотре скрыто ещё сообщений: {count}.",
};
